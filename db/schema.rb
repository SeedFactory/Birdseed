...
ActiveRecord::Schema.define(version: 20151005222310) do
  ...
  add_index "spree_featured_items", ["active"], name: "index_spree_featured_items_on_active", using: :btree
  add_index "spree_featured_items", ["position"], name: "index_spree_featured_items_on_position", using: :btree
